(() => {
  ...
  function renderFile(){
    ...
    ui.formatNote.innerHTML=`<strong>${h.alpha?'VP9 with alpha':'VP8 fast-path'} WebM.</strong>${h.audioTracks?' Audio will be transcoded to Opus.':''} OPFS streaming is used when supported.`;
  }
